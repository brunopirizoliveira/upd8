...
document.querySelectorAll('.btn-remover').forEach(function (btn) {
  btn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var clienteId, formData, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          clienteId = this.dataset.clienteId; // Crie um objeto FormData e inclua o token CSRF
          ...
          _context.prev = 3;
          _context.next = 6;
          return fetch("/clientes/".concat(clienteId), {
            method: 'DELETE',
            body: formData
          }).then(function () {
        ...
        case 9:
          ...
          console.error('Erro ao excluir cliente:', _context.t0);
        case 12:
        case "end":
...
document.querySelectorAll('.btn-edit').forEach(function (btn) {
  btn.addEventListener('click', function () {
    ...
    window.location.href = "/clientes/".concat(clienteId, "/edit");
  });
});
/******/ })()
;